...
vector<ll> ten = {1,10,100,1000,10000,100000,1000000,10000000,100000000,100000000};

void make_sft(vector<ll> &sft,ll n){
    if(n*10 + 3 < 1e9 ){
        sft.push_back(n*10+3);
        make_sft(sft,n*10+3);
    }
    if(n*10 + 5 < 1e9 ){
        sft.push_back(n*10+5);
        make_sft(sft,n*10+5);
    }
    if(n*10 + 7 < 1e9 ){
        sft.push_back(n*10+7);
        make_sft(sft,n*10+7);
    }
}
