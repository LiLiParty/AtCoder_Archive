...
int main() {
    ...
    //横
    for(int i=0; i<3; i++){
        if(S.count(A[i][0]) && S.count(A[i][1]) && S.count(A[i][2])) ans=true;
    }
    //縦
    for(int i=0; i<3; i++){
        if(S.count(A[0][i]) && S.count(A[1][i]) && S.count(A[2][i])) ans=true;
    }
    //斜め
    if(S.count(A[0][0]) && S.count(A[1][1]) && S.count(A[2][2])) ans=true;
    if(S.count(A[0][2]) && S.count(A[1][1]) && S.count(A[2][0])) ans=true;
